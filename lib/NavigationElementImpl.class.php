...
abstract class NavigationElementImpl extends ArrayObject implements NavigationElement
{
	...
	/**
	 * Sets the CSS class to used for various XHTML elements generated by the renderAsXhtml() method.
	 *
	 * @param integer $element Type of the element to set the CSS class to. See CSSCLASS_* constants.
	 * @param string $cssClassName The CSS class name. self::CSSCLASS_LEVEL_ACCESSOR (%level) will be replaced by the level value.
	 * @param boolean $appendLevelAccessor Append self::CSSCLASS_LEVEL_ACCESSOR (%level) at the end of $cssClassName.
	 *
	 * @return void
	 *
	 * @throws IllegalArgumentException
	 *
	 * @deprecated Menus and other navigation elements must be rendered with the use of the "change:menu" PHPTal tag into templates.
	 */
