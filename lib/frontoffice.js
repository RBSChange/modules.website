...
jQuery(document).ready(function(){
	...
	// Togglable sections.
	jQuery('.ctoggle > .short').attr('title', "${trans:m.website.frontoffice.click-to-view-full-description,ucf,js}").show().click(function() { 
		jQuery(this).hide();
		jQuery(this).siblings('.full').show();
	});
	jQuery('.ctoggle > .full').attr('title', "${trans:m.website.frontoffice.click-to-hide-full-description,ucf,js}").hide().click(function() { 
		jQuery(this).hide();
