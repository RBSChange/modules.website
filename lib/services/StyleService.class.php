...
class website_StyleService extends change_BaseService
{
	 ...
	 * @param website_CSSVariables $skin The skin to integrate
	...
	/**
	 * @param integer|website_CSSVariables|null $skin
	 * @return website_CSSVariables | null
	 * @throw Exception if $skin is not valid type identifier 
	 */
	private function normalizeSkin($skin)
	{
		if ($skin === null || $skin instanceof website_CSSVariables)
		{
			return $skin;
		}
	...
	public function getCSS($style, $fullEngine = 'all.all', $skin = null)
	{
		...
		{
			$ss = website_CSSStylesheet::getInstanceFromFile($sourceLocation);
	...
	public function getImageFormats($stylesheetName)
	{
		...
		$formats = array();
		$css = website_CSSStylesheet::getInstanceFromFile($sourceLocation);
