<?php
class website_BaseRewritingService extends BaseService
{
	 ...
	 * @var Array
	 */	
	protected $m_documentRules = array();
	
	/**
	 * @var Array
	 */	
	protected $m_actionRules = array();
	
	/**
	 * @var Array
	 */	
	protected $m_tagRules = array();
	...
	public function getDocumentUrl($document, $lang = null, &$additionnalParameters = array())
	{
		...
		{
			$url = $this->getPersistentProvider()->getUrlRewriting($document->getId(), $lang, $website->getId());
			if ($url !== null)
			{
