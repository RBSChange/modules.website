...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="p[normalize-space(.) ='' and not(descendant::*)]" priority="5"></xsl:template>
	...
	<xsl:template match="em[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="i[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="strong[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="b[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="del[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="strike[normalize-space(.) ='']" priority="5"></xsl:template>
	<xsl:template match="strike"><del><xsl:apply-templates /></del></xsl:template>
	
	<xsl:template match="sub[normalize-space(.) ='']" priority="5"></xsl:template>
	<xsl:template match="sub"><sub><xsl:apply-templates /></sub></xsl:template>
	
	<xsl:template match="sup[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="ol[normalize-space(.) ='']" priority="5"></xsl:template>	
	<xsl:template match="ol"><ol class="normal"><xsl:apply-templates /></ol></xsl:template>
	
	<xsl:template match="ul[normalize-space(.) ='']" priority="5"></xsl:template>	
	<xsl:template match="ul"><ul class="normal"><xsl:apply-templates /></ul></xsl:template>
	
	<xsl:template match="li[normalize-space(.) ='']" priority="5"></xsl:template>	
	<xsl:template match="li"><li><xsl:apply-templates /></li></xsl:template>

	<xsl:template match="blockquote[normalize-space(.) ='' and not(descendant::*)]" priority="5"></xsl:template>	
	...
	<xsl:template match="caption[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="span[normalize-space(.) ='']" priority="5"></xsl:template>	
	...
	<xsl:template match="abbr[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="acronym[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="rb[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="rp[normalize-space(.) ='']" priority="5"></xsl:template>
	...
	<xsl:template match="rt[normalize-space(.) ='']" priority="5"></xsl:template>
