<?php
class commands_AddDocumentBlock extends c_ChangescriptCommand
{
	/**
	 * @return string
	 */
...
Where <blockType> in:\n";
	...
	protected function validateArgs($params, $options)
	{
		if (count($params) === 3)
		{
			...
			if (!file_exists(f_util_FileUtils::buildProjectPath('modules', $moduleName, 'persistentdocument', $docName . '.xml')))
			{
